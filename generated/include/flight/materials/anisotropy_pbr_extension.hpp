// Generated by @flighthq/tool-compiler from @flighthq/materials/packages/materials/src/anisotropyPbrExtension.ts#AnisotropyPbrExtension at 903f3289590358eacc20698525e6982da2ab0e9d. Do not edit.
#pragma once
#include <cmath>
...
inline void initialize_anisotropy_pbr_extension(flight::types::EntityConstruction<flight::Ref<flight::types::AnisotropyPbrExtension>> out, std::optional<flight::StructuralRef<flight::RowReadonly<flight::RowPartial<flight::RowOf<flight::Ref<flight::types::AnisotropyPbrExtension>>>>>> opts = std::nullopt) {
  ...
  flight::row_set<flight::RowKey<"anisotropyMapUvSet">>(out, ([&]() -> std::optional<flight::types::PbrUvSet> { auto optional_chain_receiver = opts; if (!optional_chain_receiver.has_value()) return std::nullopt; return flight::row_get<flight::RowKey<"anisotropyMapUvSet">>(optional_chain_receiver.value()); }()).value_or(0.0));
  flight::row_set<flight::RowKey<"anisotropyRotation">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = opts; if (!optional_chain_receiver.has_value()) return std::nullopt; return flight::row_get<flight::RowKey<"anisotropyRotation">>(optional_chain_receiver.value()); }()).value_or(0.0));
  flight::row_set<flight::RowKey<"anisotropyStrength">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = opts; if (!optional_chain_receiver.has_value()) return std::nullopt; return flight::row_get<flight::RowKey<"anisotropyStrength">>(optional_chain_receiver.value()); }()).value_or(0.0));
