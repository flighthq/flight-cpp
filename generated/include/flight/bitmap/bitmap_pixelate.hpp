// Generated by @flighthq/tool-compiler from @flighthq/bitmap/packages/bitmap/src/bitmapPixelate.ts#BitmapPixelate at 903f3289590358eacc20698525e6982da2ab0e9d. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline void pixelate_bitmap(flight::Uint8ClampedArray out, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::BitmapRegion>>>> source, double block_size) {
  const double block = flight::maximum(1.0, flight::round(block_size));
  ...
  flight::Uint8ClampedArray data = flight::row_get<flight::RowKey<"bitmap">>(source)->data;
  {
    ...
    while ((by < h)) {
      {
        const double y_end = flight::minimum((by + block), h);
        {
          double bx = 0.0;
          while ((bx < w)) {
            {
              const double x_end = flight::minimum((bx + block), w);
              double r = 0.0;
              double g = 0.0;
              double b = 0.0;
              double a = 0.0;
