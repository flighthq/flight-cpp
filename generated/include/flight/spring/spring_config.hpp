// Generated by @flighthq/tool-compiler from @flighthq/spring/packages/spring/src/springConfig.ts#SpringConfig at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>> spring_preset_bouncy = flight::structural_ref_cast<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>>>(flight::StructuralRef<flight::RowWritable<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>>(([]() {
...
inline flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>> spring_preset_gentle = flight::structural_ref_cast<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>>>(flight::StructuralRef<flight::RowWritable<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>>(([]() {
  flight::types::EntityConstruction<flight::Ref<flight::types::SpringConfig>> out = flight::entity::allocate_entity<flight::Ref<flight::types::SpringConfig>>();
...
inline flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>> spring_preset_stiff = flight::structural_ref_cast<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>>>(flight::StructuralRef<flight::RowWritable<flight::RowOf<flight::Ref<flight::types::SpringConfig>>>>(([]() {
  flight::types::EntityConstruction<flight::Ref<flight::types::SpringConfig>> out = flight::entity::allocate_entity<flight::Ref<flight::types::SpringConfig>>();
