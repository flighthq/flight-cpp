// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/ToonMaterial.ts#ToonMaterial at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <optional>
#include <variant>
...
struct ToonMaterial : public flight::ReferenceEnabled {
  std::optional<flight::Ref<flight::types::EntityRuntime>> entity_runtime_key;
  flight::String kind;
  ...
  std::optional<std::variant<flight::Ref<entity_runtime_key_flip_x_flip_y_uv_offset_uv_rotation_uv_scale_color_space_sampler_version_dimension_sources>, flight::Ref<entity_runtime_key_flip_x_flip_y_uv_offset_uv_rotation_uv_scale_color_space_sampler_version_dimension_source>, flight::Ref<entity_runtime_key_flip_x_flip_y_uv_offset_uv_rotation_uv_scale_color_space_sampler_version_dimension_sources_1>, flight::Ref<Texture2D>>> ramp;
  double steps;
};

inline const flight::String toon_material_kind = flight::String("ToonMaterial");
