// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/Shape.ts#Shape at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
#include <functional>
#include <optional>
...
struct ShapeData : public flight::ReferenceEnabled {
  std::optional<flight::Ref<flight::types::EntityRuntime>> entity_runtime_key;
  flight::Array<flight::types::ShapeCommandToken> commands;
};

struct ShapeRuntime : public flight::ReferenceEnabled {
...
inline const flight::String shape_kind = flight::String("Shape");
