// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/BlinnPhongMaterial.ts#BlinnPhongMaterial at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <optional>
#include <variant>
...
struct BlinnPhongMaterial : public flight::ReferenceEnabled {
  ...
  double shininess;
  double specular;
  std::optional<std::variant<flight::Ref<entity_runtime_key_flip_x_flip_y_uv_offset_uv_rotation_uv_scale_color_space_sampler_version_dimension_sources>, flight::Ref<entity_runtime_key_flip_x_flip_y_uv_offset_uv_rotation_uv_scale_color_space_sampler_version_dimension_source>, flight::Ref<entity_runtime_key_flip_x_flip_y_uv_offset_uv_rotation_uv_scale_color_space_sampler_version_dimension_sources_1>, flight::Ref<Texture2D>>> specular_map;
};
