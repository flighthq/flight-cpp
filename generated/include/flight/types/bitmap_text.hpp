// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/BitmapText.ts#BitmapText at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
...
struct BitmapTextPage;
struct BitmapTextRuntime;
struct BitmapText;
struct BitmapTextOptions;
using BitmapTextAlign = flight::String;
} // namespace flight::types
...
struct BitmapTextData : public flight::ReferenceEnabled {
  std::optional<flight::Ref<flight::types::EntityRuntime>> entity_runtime_key;
  BitmapTextAlign align;
  flight::String ellipsis;
  std::optional<flight::Ref<flight::types::GlyphSource>> glyph_source;
...
struct BitmapTextPage : public flight::ReferenceEnabled {
  flight::Ref<flight::types::TextureAtlas> atlas;
  flight::Uint16Array ids;
  double instance_count;
  flight::Float32Array transforms;
};

struct BitmapTextRuntime : public flight::ReferenceEnabled {
  ...
  double glyph_layout_version;
  double line_count;
  flight::Array<flight::Ref<BitmapTextPage>> pages;
  bool truncated;
};

struct BitmapText : public flight::ReferenceEnabled {
  flight::Ref<BitmapTextData> data;
  bool enabled;
...
struct BitmapTextOptions : public flight::ReferenceEnabled {
  std::optional<BitmapTextAlign> align;
  std::optional<flight::String> ellipsis;
  std::optional<double> letter_spacing;
  std::optional<double> line_height;
  std::variant<double, flight::Null, flight::Undefined> max_lines;
  std::optional<flight::String> text;
  std::variant<double, flight::Null, flight::Undefined> wrap_width;
};

inline const flight::String bitmap_text_kind = flight::String("BitmapText");
