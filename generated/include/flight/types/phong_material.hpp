// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/PhongMaterial.ts#PhongMaterial at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <optional>
#include <variant>
...
struct PhongMaterial : public flight::ReferenceEnabled {
  std::optional<flight::Ref<flight::types::EntityRuntime>> entity_runtime_key;
  flight::String kind;
...
inline const flight::String phong_material_kind = flight::String("PhongMaterial");
