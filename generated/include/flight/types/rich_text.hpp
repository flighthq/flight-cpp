// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/RichText.ts#RichText at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
...
namespace flight::types { struct RichTextContent; }
namespace flight::types { struct Scene2D; }
namespace flight::types { struct TextFieldSignals; }
namespace flight::types { struct TextFormat; }
namespace flight::types { struct TextFormatRange; }
namespace flight::types { struct TextInputState; }
namespace flight::types { struct TextLabel; }
namespace flight::types { struct TextLabelData; }
namespace flight::types { struct TextLabelRuntime; }
...
struct RichTextData : public flight::ReferenceEnabled {
  std::optional<flight::Ref<flight::types::EntityRuntime>> entity_runtime_key;
  flight::types::TextAutoSize auto_size;
  double height;
  flight::String text;
  flight::Ref<flight::types::TextFormat> text_format;
  flight::Ref<flight::types::TextVerticalAlign> vertical_align;
  double width;
  bool background;
  ...
  double border_color;
  bool condense_white;
  flight::Ref<flight::types::TextFormat> default_text_format;
  double max_chars;
  ...
  bool selectable;
  double text_color;
  flight::Array<flight::Ref<flight::types::TextFormatRange>> text_format_ranges;
  bool word_wrap;
};

struct RichTextRuntime : public flight::ReferenceEnabled {
  ...
  std::function<flight::Ref<flight::types::TextLayoutParams>(flight::Ref<flight::types::TextLabel>, flight::Ref<flight::types::TextMeasureFunction>)> build_text_layout_params;
  ...
  std::optional<flight::Ref<flight::types::TextInputState>> input;
  std::optional<flight::Ref<flight::types::RichTextContent>> rich_text_content;
  double selection_begin_index;
  double selection_end_index;
  std::optional<flight::Ref<flight::types::TextFieldSignals>> text_field_signals;
};

struct RichText : public flight::ReferenceEnabled {
  flight::Ref<RichTextData> data;
  bool enabled;
...
inline const flight::String rich_text_kind = flight::String("RichText");
