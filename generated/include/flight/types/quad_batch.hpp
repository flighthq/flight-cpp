// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/QuadBatch.ts#QuadBatch at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
...
struct QuadBatchRuntime;
struct QuadBatch;
} // namespace flight::types

#include <flight/types/material.hpp>
#include <flight/types/node2_d.hpp>
#include <flight/types/quad_transform_type.hpp>
...
struct QuadBatchData : public flight::ReferenceEnabled {
  ...
  flight::types::QuadTransformType transform_type;
};

struct QuadBatchRuntime : public flight::ReferenceEnabled {
  ...
  std::optional<flight::Float32Array> instance_velocities;
};

struct QuadBatch : public flight::ReferenceEnabled {
  flight::Ref<QuadBatchData> data;
  bool enabled;
...
inline const flight::String quad_batch_kind = flight::String("QuadBatch");
