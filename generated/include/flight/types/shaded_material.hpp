// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/ShadedMaterial.ts#ShadedMaterial at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <optional>
#include <variant>
...
struct ShadedMaterial : public flight::ReferenceEnabled {
  std::optional<flight::Ref<flight::types::EntityRuntime>> entity_runtime_key;
  flight::String kind;
  ...
  flight::Array<flight::Ref<flight::types::Modifier>> modifiers;
...
inline const flight::String shaded_material_kind = flight::String("ShadedMaterial");
