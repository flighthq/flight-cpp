// Generated by @flighthq/tool-compiler from @flighthq/types/AreaLightOptions.ts#AreaLightOptions. Do not edit.
#pragma once
#include <optional>
...
struct AreaLightOptions {
  ...
  std::optional<Vector3Like> position;
  std::optional<double> range;
  std::optional<Vector3Like> right;
