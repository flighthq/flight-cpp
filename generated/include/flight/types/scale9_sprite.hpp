// Generated by @flighthq/tool-compiler from @flighthq/types/packages/types/src/Scale9Sprite.ts#Scale9Sprite at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
...
namespace flight::types { struct Sprite; }
namespace flight::types { struct SpriteData; }
namespace flight::types { struct SpriteRuntime; }
...
struct Scale9SpriteData;
struct Scale9SpriteRuntime;
struct Scale9Sprite;
} // namespace flight::types
...
struct Scale9SpriteData : public flight::ReferenceEnabled {
  std::optional<flight::Ref<flight::types::EntityRuntime>> entity_runtime_key;
  std::optional<flight::Ref<flight::types::Texture>> texture;
  flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::types::RectangleLike>>> scale9_grid;
};

struct Scale9SpriteRuntime : public flight::ReferenceEnabled {
  ...
  std::optional<flight::Ref<flight::types::Texture>> local_bounds_texture;
  double local_bounds_texture_version;
};

struct Scale9Sprite : public flight::ReferenceEnabled {
  flight::Ref<Scale9SpriteData> data;
  bool enabled;
...
inline const flight::String scale9_sprite_kind = flight::String("Scale9Sprite");
