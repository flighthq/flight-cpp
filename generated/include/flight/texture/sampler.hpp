...
inline bool equals_sampler(std::variant<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SamplerLike>>>>, flight::Null, flight::Undefined> a, std::variant<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SamplerLike>>>>, flight::Null, flight::Undefined> b) {
  if ((!std::get<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SamplerLike>>>>>(a) || !std::get<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::SamplerLike>>>>>(b))) {
    return false;
  }
...
inline void initialize_sampler(flight::types::EntityConstruction<flight::Ref<flight::types::Sampler>> out, std::optional<flight::Ref<anisotropy_mag_filter_min_filter_mipmaps_wrap_u_wrap_v>> opts = std::nullopt) {
  ...
  flight::row_set<flight::RowKey<"magFilter">>(out, ([&]() -> std::optional<flight::types::TextureFilter> { auto optional_chain_receiver = opts; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->mag_filter; }()).value_or(flight::String("linear")));
  flight::row_set<flight::RowKey<"minFilter">>(out, ([&]() -> std::optional<flight::types::TextureFilter> { auto optional_chain_receiver = opts; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->min_filter; }()).value_or(flight::String("linear-mipmap-linear")));
  ...
  flight::row_set<flight::RowKey<"wrapU">>(out, ([&]() -> std::optional<flight::types::TextureWrap> { auto optional_chain_receiver = opts; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->wrap_u; }()).value_or(flight::String("clamp-to-edge")));
  flight::row_set<flight::RowKey<"wrapV">>(out, ([&]() -> std::optional<flight::types::TextureWrap> { auto optional_chain_receiver = opts; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->wrap_v; }()).value_or(flight::String("clamp-to-edge")));
}
...
inline flight::Ref<flight::types::Sampler> create_sampler(std::optional<flight::Ref<anisotropy_mag_filter_min_filter_mipmaps_wrap_u_wrap_v>> opts = std::nullopt) {
  flight::types::EntityConstruction<flight::Ref<flight::types::Sampler>> out = flight::entity::allocate_entity<flight::Ref<flight::types::Sampler>>();
  initialize_sampler(out, opts.value());
  return flight::entity::finish_entity(out);
}
