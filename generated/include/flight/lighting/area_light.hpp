// Generated by @flighthq/tool-compiler from @flighthq/lighting/packages/lighting/src/areaLight.ts#AreaLight at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline flight::Ref<flight::types::AreaLight> clone_area_light(flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::AreaLight>>>> source) {
  ...
  flight::row_set<flight::RowKey<"right">>(out, flight::geometry::clone_vector3(flight::row_get<flight::RowKey<"right">>(source)));
...
inline void set_area_light_orientation(flight::Ref<flight::types::AreaLight> out, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::Vector3Like>>>> direction, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::Vector3Like>>>> right, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::Vector3Like>>>> up) {
  ...
  auto existing_right_len = std::sqrt((((out->right->x * out->right->x) + (out->right->y * out->right->y)) + (out->right->z * out->right->z)));
  auto existing_up_len = std::sqrt((((out->up->x * out->up->x) + (out->up->y * out->up->y)) + (out->up->z * out->up->z)));
  if ((dir_len > 0.0)) {
