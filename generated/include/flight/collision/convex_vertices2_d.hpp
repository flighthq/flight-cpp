// Generated by @flighthq/tool-compiler from @flighthq/collision/packages/collision/src/convexVertices2D.ts#ConvexVertices2D at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline void write_obb_vertices(flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::CollisionObb2D>>>> obb, flight::Float64Array out) {
  ...
  auto cos = std::cos(flight::row_get<flight::RowKey<"rotation">>(obb));
  auto sin = std::sin(flight::row_get<flight::RowKey<"rotation">>(obb));
