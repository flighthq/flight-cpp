// Generated by @flighthq/tool-compiler from @flighthq/collision/packages/collision/src/collisionShapeValidation2D.ts#CollisionShapeValidation2D at 903f3289590358eacc20698525e6982da2ab0e9d. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
    ...
    while ((i_2 < static_cast<double>(points.size()))) {
      {
        ...
        if ((!flight::to_boolean(std::isfinite(x_2)) || !flight::to_boolean(std::isfinite(y_2)))) {
          return std::optional<flight::String>{flight::String("degenerate-shape")};
        }
        if ((x_2 < min_x)) {
          (min_x = x_2);
