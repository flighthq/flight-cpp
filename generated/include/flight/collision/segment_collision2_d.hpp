// Generated by @flighthq/tool-compiler from @flighthq/collision/packages/collision/src/segmentCollision2D.ts#SegmentCollision2D at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline bool test_segment_obb_collision2_d(flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::CollisionSegment2D>>>> a, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::CollisionObb2D>>>> b) {
  ...
  const double cos = std::cos(flight::row_get<flight::RowKey<"rotation">>(b));
  const double sin = std::sin(flight::row_get<flight::RowKey<"rotation">>(b));
