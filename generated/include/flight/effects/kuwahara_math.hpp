// Generated by @flighthq/tool-compiler from @flighthq/effects/packages/effects/src/kuwaharaMath.ts#KuwaharaMath at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline double compute_kuwahara_gaussian_weights(double radius, flight::Float32Array out) {
  const double r = flight::maximum(1.0, std::floor(radius));
