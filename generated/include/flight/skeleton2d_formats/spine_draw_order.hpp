// Generated by @flighthq/tool-compiler from @flighthq/skeleton2d-formats/packages/skeleton2d-formats/src/spineDrawOrder.ts#SpineDrawOrder at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
#include <cmath>
...
#ifndef FLIGHT_COMPILER_ANONYMOUS__FLIGHTHQ_SKELETON2D_FORMATS_OFFSET_SLOT_INDEX_78B23845EFACF0F9
#define FLIGHT_COMPILER_ANONYMOUS__FLIGHTHQ_SKELETON2D_FORMATS_OFFSET_SLOT_INDEX_78B23845EFACF0F9
struct offset_slot_index_78b23845efacf0f9 : public flight::ReferenceEnabled {
  double offset;
  double slot_index;
};
#endif // FLIGHT_COMPILER_ANONYMOUS__FLIGHTHQ_SKELETON2D_FORMATS_OFFSET_SLOT_INDEX_78B23845EFACF0F9

inline std::optional<flight::Array<double>> resolve_spine_draw_ordering(flight::SequenceView<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<offset_slot_index_78b23845efacf0f9>>>>> moves, double slot_count) {
  if ((slot_count <= 0.0)) {
    return std::nullopt;
  }
