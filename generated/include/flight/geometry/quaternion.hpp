// Generated by @flighthq/tool-compiler from @flighthq/geometry/packages/geometry/src/quaternion.ts#Quaternion at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline void set_quaternion_from_euler(flight::types::QuaternionLike out, double x, double y, double z, std::optional<flight::types::EulerOrder> order = std::nullopt) {
  ...
  auto c2 = std::cos((y / 2.0));
  auto s2 = std::sin((y / 2.0));
  auto c3 = std::cos((z / 2.0));
  auto s3 = std::sin((z / 2.0));
  {
