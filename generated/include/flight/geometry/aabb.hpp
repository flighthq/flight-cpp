// Generated by @flighthq/tool-compiler from @flighthq/geometry/packages/geometry/src/aabb.ts#Aabb at 903f3289590358eacc20698525e6982da2ab0e9d. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline bool is_aabb_intersecting_sphere(flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::AabbLike>>>> aabb, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::types::BoundingSphereLike>>> sphere) {
  ...
  const double cy = flight::row_get<flight::RowKey<"center">>(sphere)->y;
  const double cz = flight::row_get<flight::RowKey<"center">>(sphere)->z;
  const double dx = flight::maximum((flight::row_get<flight::RowKey<"min">>(aabb)->x - cx), 0.0, (cx - flight::row_get<flight::RowKey<"max">>(aabb)->x));
  const double dy = flight::maximum((flight::row_get<flight::RowKey<"min">>(aabb)->y - cy), 0.0, (cy - flight::row_get<flight::RowKey<"max">>(aabb)->y));
  const double dz = flight::maximum((flight::row_get<flight::RowKey<"min">>(aabb)->z - cz), 0.0, (cz - flight::row_get<flight::RowKey<"max">>(aabb)->z));
