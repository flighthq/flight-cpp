// Generated by @flighthq/tool-compiler from @flighthq/geometry/packages/geometry/src/boundingSphere.ts#BoundingSphere at 7e2fc7df5378313ceaf21ba8d6ef39cc18a6f4ad. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline flight::Ref<flight::types::BoundingSphere> create_bounding_sphere(std::optional<double> center_x = std::nullopt, std::optional<double> center_y = std::nullopt, std::optional<double> center_z = std::nullopt, std::optional<double> radius = std::nullopt) {
  auto center = flight::geometry::create_vector3((center_x.has_value() ? center_x.value() : 0.0), (center_y.has_value() ? center_y.value() : 0.0), (center_z.has_value() ? center_z.value() : 0.0));
  ...
  initialize_bounding_sphere(out, center, (radius.has_value() ? radius.value() : -1.0));
...
inline void transform_bounding_sphere_by_matrix4(flight::types::BoundingSphereLike out, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::types::BoundingSphereLike>>> sphere, flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::types::Matrix4Like>>> m) {
  ...
  const double max_scale = flight::maximum(sx, sy, sz);
  (out->center->x = tcx);
  (out->center->y = tcy);
  (out->center->z = tcz);
