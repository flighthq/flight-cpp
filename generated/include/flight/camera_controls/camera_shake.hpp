// Generated by @flighthq/tool-compiler from @flighthq/camera-controls/packages/camera-controls/src/cameraShake.ts#CameraShake at 903f3289590358eacc20698525e6982da2ab0e9d. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline void initialize_camera_shake(flight::types::EntityConstruction<flight::Ref<flight::types::CameraShake>> out, std::optional<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::CameraShakeOptions>>>>> options = std::nullopt) {
  flight::row_set<flight::RowKey<"decay">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return flight::row_get<flight::RowKey<"decay">>(optional_chain_receiver.value()); }()).value_or(1.5));
  flight::row_set<flight::RowKey<"frequency">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return flight::row_get<flight::RowKey<"frequency">>(optional_chain_receiver.value()); }()).value_or(15.0));
  flight::row_set<flight::RowKey<"rotationAmplitude">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return flight::row_get<flight::RowKey<"rotationAmplitude">>(optional_chain_receiver.value()); }()).value_or(3.0));
  flight::row_set<flight::RowKey<"time">>(out, 0.0);
  flight::row_set<flight::RowKey<"translationAmplitude">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return flight::row_get<flight::RowKey<"translationAmplitude">>(optional_chain_receiver.value()); }()).value_or(0.5));
