// Generated by @flighthq/tool-compiler from @flighthq/camera-controls/packages/camera-controls/src/cameraShake.ts#CameraShake at 1274ec5c923947dc64d5ffedcbd8169fc758cd9f. Do not edit.
#pragma once
#include <cmath>
#include <cstdint>
...
inline void initialize_camera_shake(flight::types::EntityConstruction<flight::Ref<flight::types::CameraShake>> out, std::optional<flight::StructuralRef<flight::RowReadonly<flight::RowOf<flight::Ref<flight::types::CameraShakeOptions>>>>> options = std::nullopt) {
  flight::row_set<flight::RowKey<"decay">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->decay; }()).value_or(1.5));
  flight::row_set<flight::RowKey<"frequency">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->frequency; }()).value_or(15.0));
  flight::row_set<flight::RowKey<"rotationAmplitude">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->rotation_amplitude; }()).value_or(3.0));
  flight::row_set<flight::RowKey<"time">>(out, 0.0);
  flight::row_set<flight::RowKey<"translationAmplitude">>(out, ([&]() -> std::optional<double> { auto optional_chain_receiver = options; if (!optional_chain_receiver.has_value()) return std::nullopt; return optional_chain_receiver.value()->translation_amplitude; }()).value_or(0.5));
