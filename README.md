...
adapters populate the exact generated audio-device, text-clipboard, cursor, device, platform, screen-query, application-visibility, and fullscreen records. See the
