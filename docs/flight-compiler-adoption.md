...
- `npm run sdk:generate:sdl` composes the GL, WebGPU, and SDL application profiles. It emits 1,098 modules; all 17
  ...
  refusals fall from the SDL/GL profile's 242 to 126. Window, document, `HTMLElement`, animation-frame
...
`TextEncoder`, `AudioBuffer`, `AudioBufferOptions`, bare `parseFloat`, and bare `isFinite`
